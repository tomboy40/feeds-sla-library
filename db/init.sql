...
CREATE INDEX IF NOT EXISTS idx_send_app ON interfaces(send_app_id);
CREATE INDEX IF NOT EXISTS idx_received_app ON interfaces(received_app_id);
CREATE INDEX IF NOT EXISTS idx_interface_status ON interfaces(interface_status); 